        ...
        <div className='flex justify-center w-full pt-8'>
            <div className='max-w-screen-lg w-full'>
                <input onChange={(e) => {
                    ...
                    className="mt-12 pt-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 
    ...
    return <div className='mt-6'>
        <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            ...
            <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                ...
                <textarea onChange={onChange} id="editor" className="border-none outline-none w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required />
            </div>
